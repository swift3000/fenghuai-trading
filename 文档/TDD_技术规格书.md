...
> **对应版本**：v1.0（纯小程序版，3周交付，技术服务费5,000元）  
> **工期**：3周  
> **预算**：5,000元（技术服务费包干，不含小程序注册/认证/服务器/云资源等甲方承担的第三方费用）
...
本项目为丰淮商贸的采购下单场景提供数字化解决方案，提供两套可选技术方案：

| 方案 | 后端 | 核心能力 | 甲方费用 |
|------|------|----------|---------|
| 方案A（推荐） | 微信云开发 | 零运维，云函数+云数据库 | 约840元/首年 |
| 方案B | 轻量云服务器 | 数据自主可控，Node.js+MySQL | 约1,300~1,900元/首年 |

两套方案前端均为微信原生小程序，功能完全一致。
...
- Web 后台为单 HTML 文件，可直接丢 CDN 或云开发静态托管
- 所有后端逻辑封装在 8 个云函数内
- 数据库仅 6 个核心集合，无冗余
...
#### 2.2.2 Web 后台 Excel 导出流程（前端 SheetJS）
...
| 方案 | 技术服务费 | 工期 | 交付内容 |
|------|-----------|------|---------|
| 方案A：小程序 + 微信云开发 | **5,000元**（包干） | 3周 | 微信小程序全功能 |
| 方案B：小程序 + 轻量服务器 | **5,000元**（包干） | 3周 | 同方案A，后端部署在甲方服务器 |

> 5,000元为技术服务费包干价，含首月免费运维。不含小程序注册/认证/服务器/云资源/域名等第三方费用。
...
| 云开发基础包 | 240元/年 | 240元/年 | 19.9元/月 |
| 域名 | 不需要 | 不需要 | 云开发免域名 |
| **合计** | **约840元** | **约540元/年** | **最省钱** |
...
| 微信小程序注册 | 300元 | - | 一次性 |
| 微信认证 | 300元 | 300元/年 | 每年续费 |
| 轻量应用服务器 | 600~1,200元/年 | 600~1,200元/年 | 2核2G |
| 域名 + SSL | 100元/年 | 100元/年 | SSL免费 |
| **合计** | **约1,300~1,900元** | **约1,000~1,600元/年** | 数据自主 |

### 7.3.3 方案对比

| 对比项 | 方案A（云开发） | 方案B（轻量服务器） |
|--------|----------------|-------------------|
| 技术服务费 | 5,000元 | 5,000元 |
| 甲方首年费用 | 约840元 | 约1,300~1,900元 |
| 甲方次年费用 | 约540元/年 | 约1,000~1,600元/年 |
| 运维复杂度 | 零运维 | 需基础维护 |
| 数据归属 | 微信云托管 | 甲方自有 |
| **推荐** | **✅ 推荐** | 有运维能力选此 |
